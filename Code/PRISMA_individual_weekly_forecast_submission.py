# =============================================================================
# PRISMA HEALTH INDIVIDUAL FACILITIES — WEEKLY FORECAST SUBMISSION  (QRF_level_sqrt)
#
...
#   Uses saved optimal parameters from PRISMA_QRF_sqrt_selected_params.csv
...
#
#     <SUBMISSION_DIR>/Hossain_Sakhawat_facility_respiratory_PRISMA.csv
#
#   Columns:
...
PARAMS_CSV = os.path.join(
    BASE_DIR, "submission", "prisma_qrf_sqrt",
    "PRISMA_QRF_sqrt_selected_params.csv"
)
...
SUBMISSION_NAME = "Hossain_Sakhawat_facility_respiratory_PRISMA"   # no extension
...
if __name__ == "__main__":
    ...
    print("="*70)
    print("PRISMA INDIVIDUAL FACILITIES — WEEKLY FORECAST SUBMISSION")
    ...
    # Load data
    print("\nLoading Prisma data …")
    raw_fac, matched = load_prisma_data(INPUT_DIR, PRISMA_FACILITIES)
